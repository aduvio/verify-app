...
- Current repair scope is SCR-001 through SCR-003 only. Keep BUILD_STATUS current; validate with formatting, analysis, tests, and web build. Session storage is in memory, not durable.
